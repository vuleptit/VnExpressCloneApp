...
public class FragmentHistory extends Fragment implements HistoryAdapter.ClickListener, RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    private void init(View view) {
        ...
        list = appDataBase.articleDao().getAllArticleState(State.STATE_HISTORY);
